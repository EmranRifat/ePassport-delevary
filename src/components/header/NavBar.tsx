...
const Navbar = ({ onMenuClick }: NavbarProps) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-green-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-sm ">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex gap-2 mr-4">
            ...
            <div className="flex gap-2">
              ...
              <p className="flex items-center text-base  text-gray-800 dark:text-gray-200">
      ...
      {mobileMenuOpen && (
        <div className=" absolute top-16 right-10 w-35 rounded-xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 z-50">
