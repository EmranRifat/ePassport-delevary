  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-800/50 rounded-md">
      <div className="flex-1 flex flex-col">
        {/* Main Content */}
        <main className="flex-1 w-full px-2 md:px-4  py-8">
          <div className="">
          ...
          <div className="mb-6 bg-white border border-gray-300 rounded-lg p-5 shadow-sm">
            <div className="w-full flex justify-between items-center gap-4">
              <div className="w-[45%] group relative flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 ring-1 ring-blue-300/40 shadow-sm hover:shadow-md transition-all duration-200">
                <span
                  aria-hidden
                  className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-blue-300/20 blur-2xl"
                />
                <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-white/70 text-blue-600 ring-1 ring-blue-200 shadow-sm">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="w-[45%] group relative flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-green-50 via-green-100 to-green-50 ring-1 ring-green-300/40 shadow-sm hover:shadow-md transition-all duration-200">
                <span
                  aria-hidden
                  className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-green-300/20 blur-2xl"
                />
                <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-white/70 text-green-600 ring-1 ring-green-200 shadow-sm">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
          ...
          <div>
            ...
            <div className="flex justify-between items-center gap-8 w-full ">
              ...
              <div className="w-[49%]">
                <Button
                  color="secondary"
                  className="flex items-center gap-2 md:ml-auto mt-4"
                >
                  Report Print
                  <svg
                    className="w-5 h-5"
